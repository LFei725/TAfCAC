...
def data_convert(file_name):
    output_all_NLI_file = open(args.out_path + "NLI_" + file_name, "w", encoding='utf-8')  # eg. NLI_train.json
    ...
    for nli_str in NLI_list:
        ...
        output_NLI_file = open(args.out_path + "NLI_" + nli_str + "_" + file_name, "w",
                               encoding='utf-8')  # eg. NLI_contradiction_train.json
