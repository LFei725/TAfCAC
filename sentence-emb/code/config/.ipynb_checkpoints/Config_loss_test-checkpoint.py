...
#             self.bertRep = h5py.File(os.path.join(self.data_path, "rams_bert_nli_legal.h5"), "r")   
#             self.bertRep = h5py.File(os.path.join(self.data_path, "rams_bert_nli_legal_ocnli.h5"), "r")   
#             self.bertRep = h5py.File(os.path.join(self.data_path, "rams_bert_nli_legal_ocnli_ft8-11.h5"), "r")  
#             self.bertRep = h5py.File(os.path.join(self.data_path, "rams_bert_nli_legal_ocnli_ft8-11pc.h5"), "r")  
#             self.bertRep = h5py.File(os.path.join(self.data_path, "rams_bert_nli_legal_ocnli_ft0-7.h5"), "r")  
# ---
#             self.bertRep = h5py.File(os.path.join(self.data_path, "rams_bert_nli_legal_filter.h5"), "r")  
#             self.bertRep = h5py.File(os.path.join(self.data_path, "rams_bert_nli_legal_filter_ocnli.h5"), "r")  
#             self.bertRep = h5py.File(os.path.join(self.data_path, "rams_bert_nli_legal_filter_ocnli_ft8-11.h5"), "r") 
#             self.bertRep = h5py.File(os.path.join(self.data_path, "rams_bert_nli_legal_filter_ocnli_ft8-11pc.h5"), "r")  
#             self.bertRep = h5py.File(os.path.join(self.data_path, "rams_bert_nli_legal_filter_ocnli_ft0-7.h5"), "r") 
    
# -----------cmnli + t5-pegasus-base 生成的数据集------------
#             self.bertRep = h5py.File(os.path.join(self.data_path, "rams_bert_new_nli_legal.h5"), "r")   
#             self.bertRep = h5py.File(os.path.join(self.data_path, "rams_bert_new_nli_legal_ocnli.h5"), "r")   
#             self.bertRep = h5py.File(os.path.join(self.data_path, "rams_bert_new_nli_legal_ocnli_ft8-11.h5"), "r")  
#             self.bertRep = h5py.File(os.path.join(self.data_path, "rams_bert_new_nli_legal_ocnli_ft8-11pc.h5"), "r")  
#             self.bertRep = h5py.File(os.path.join(self.data_path, "rams_bert_new_nli_legal_ocnli_ft0-7.h5"), "r")  
# ---
...
#             self.bertRep = h5py.File(os.path.join(self.data_path, "rams_bert_new_filter_nli_legal_ocnli_ft8-11.h5"), "r") 
#             self.bertRep = h5py.File(os.path.join(self.data_path, "rams_bert_new_filter_nli_legal_ocnli_ft8-11pc.h5"), "r")  
#             self.bertRep = h5py.File(os.path.join(self.data_path, "rams_bert_new_filter_nli_legal_ocnli_ft0-7.h5"), "r") 
...
#                 print("-- changed lr ", self.lr, " at epoch ", epoch)
            ...
            for data in self.get_train_batch():  # 一个data是一个doc  乱序的，doc[index]对应raw_data里面的索引
                ...
                raw_loss_list.append(round(num, 4))
...
#                     total_money += self.money_str2num(deter_money_list[0])
            ...
            logging('-' * 89)
#             print("epoch", epoch, " loss in [1,+∞)=",raw_loss_list[0]," loss in [0.5,1)=",raw_loss_list[1],
#                   " loss in [0.1,0.5)=",raw_loss_list[2]," loss in [0.01,0.1)=",raw_loss_list[3],
#                   " loss in [0.001,0.01)=",raw_loss_list[4]," loss in [0,0.001)=",raw_loss_list[5])
#             print("epoch-",epoch,"raw_loss_list:",raw_loss_list)
            total_loss_list.append(raw_loss_list)
        ...
        # total_loss_list
#         for idx, raw_loss_list in enumerate(total_loss_list):
#              print("epoch", idx, " loss in [1,+∞)=",raw_loss_list[0]," loss in [0.5,1)=",raw_loss_list[1],
#                   " loss in [0.1,0.5)=",raw_loss_list[2]," loss in [0.01,0.1)=",raw_loss_list[3],
#                   " loss in [0.001,0.01)=",raw_loss_list[4]," loss in [0,0.001)=",raw_loss_list[5])
