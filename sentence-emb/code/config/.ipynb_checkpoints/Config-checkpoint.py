...
#             self.bertRep = h5py.File(os.path.join(self.data_path, "rams_bert_nli_legal_ocnli_ft8-11pc.h5"), "r")  # 已有，正在
...
#             self.bertRep = h5py.File(os.path.join(self.data_path, "rams_bert_new_filter_nli_legal_ocnli_ft0-7.h5"), "r")   # 已有，已跑
    ...
    def load_dev_data(self):
        ...
        self.data_dev_token = np.load(
            os.path.join(self.data_path, prefix + '_token.npy'))  # prepro/train_token.npy shape=[doc_num, Max_sent_indoc, max_sent_length]
...
#         wandb.init(project="money_extraction",
#                    config=config1)
#                    # ,mode="offline")
